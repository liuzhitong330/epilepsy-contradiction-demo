...
<section id="hero">
  <div class="hero-inner container">
    ...
    <div class="hero-meta">
      ...
      <span class="hero-dot">·</span>
      <strong>{n_contradictions} adjudicated contradiction candidate</strong>
      <span class="hero-dot">·</span>
      Built by Cathy Liu
    </div>
    <div class="hero-ctas">
  ...
  <div class="container">
    ...
    <div class="metrics-grid">
      ...
      <div class="metric-card">
        ...
        <div class="metric-label">Contradiction candidates adjudicated</div>
      </div>
    </div>
  </div>
</section>
...
<section id="demo">
  <div class="container">
    ...
    <h2>An adjudicated contradiction candidate — end-to-end trace</h2>
    <p class="section-sub">
...
&#125;</pre>
    ...
    <p style="font-size:.85rem;font-style:italic;color:var(--muted);margin-top:1.2rem;max-width:860px">
      ...
      <div class="trace-step">
        <div class="trace-step-header">
          <div class="trace-step-num">5</div>
          <span class="trace-step-title">Generated intervention question</span>
          <span class="trace-step-method">Auto-generated from contradiction output</span>
        </div>
        <div class="llm-output">
          <pre>&#123;
  <span class="json-key">"source_contradiction"</span>:   <span class="json-str">"conditional_contradiction"</span>,
  <span class="json-key">"hidden_variable"</span>:        <span class="json-str">"disease subtype (TSC vs. healthy)"</span>,
  <span class="json-key">"intervention_question"</span>: <span class="json-str">"What somatostatin receptor agonist
                            dosage produces consistent GABAergic
                            current modulation across TSC and
                            wild-type granule cells?"</span>,
  <span class="json-key">"optimization_target"</span>:   <span class="json-str">"seizure suppression robustness
                            across circuit contexts"</span>,
  <span class="json-key">"suggested_next_step"</span>:   <span class="json-str">"Parameterize SST receptor sensitivity
                            as a variable in a TVB epilepsy model
                            and run RL-based dosage optimization"</span>
&#125;</pre>
        </div>
        <p style="font-size:.82rem;font-style:italic;color:var(--muted);margin-top:.9rem">
          Generated by prompting Claude with the contradiction classification output — no additional human input required.
        </p>
      </div>
...
<section id="philosophy">
  <div class="container">
    ...
    <div class="problem-paras" style="margin-top:2rem">
      <div class="problem-para">
        <p>This system is built around inspectable reasoning. Every output — extracted claim, candidate pair, classification decision — can be traced back to the source abstract and the exact logic that produced it.</p>
      </div>
      <div class="problem-para">
        <p>The pipeline deliberately separates rule-based filtering from LLM judgment, so failure modes are locatable: if a candidate pair is wrong, it is either a fuzzy match error (Stage 3a) or an LLM classification error (Stage 3b), not an inscrutable black box.</p>
      </div>
      <div class="problem-para">
        <p>Honest limitations are documented inline rather than buried in supplementary material. The goal is a system a domain expert can audit, not just a result they are asked to trust.</p>
      </div>
    </div>
  </div>
</section>
